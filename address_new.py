...
class address_new(unittest.TestCase):
    ...
    def create_group(self, wd, name, middlename, lastname, nickname, title, company, adrdress, home, mobile, work, fax,
                     email, email2, email3, homapage, byear, ayear, address2, phone2, notes):
        ...
        wd.find_element_by_name("address").send_keys(adrdress)
        ...
        wd.find_element_by_name("homepage").send_keys(homapage)
