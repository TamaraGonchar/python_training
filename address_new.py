...
class address_new(unittest.TestCase):
    ...
    def test_address_new(self):
        ...
        wd.find_element_by_name("nickname").send_keys("AnPet")
        ...
        wd.find_element_by_name("home").send_keys("84951234567")
        wd.find_element_by_name("mobile").click()
        wd.find_element_by_name("mobile").clear()
        wd.find_element_by_name("mobile").send_keys("89161234567")
        ...
        wd.find_element_by_name("email2").send_keys("anp@an.ru")
        wd.find_element_by_name("email3").click()
        wd.find_element_by_name("email3").clear()
        wd.find_element_by_name("email3").send_keys("aniv@an.ru")
        wd.find_element_by_name("homepage").click()
        wd.find_element_by_name("homepage").clear()
        wd.find_element_by_name("homepage").send_keys("annaivanova.ru")
